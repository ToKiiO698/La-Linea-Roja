    ...
    function addTask(taskText) {
        ...
        li.innerHTML = `
            <div class="flex justify-between items-center">
                ...
                <button class="complete-btn bg-green-500 hover:bg-green-600 text-white py-1 px-2 rounded">Accompli</button>
                <button class="delete-btn bg-red-500 hover:bg-red-600 text-white py-1 px-2 rounded">Supprimer</button>
            </div>
        `;
